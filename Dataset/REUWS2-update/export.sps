...
insert file="REUWS2-update/load.sps".
*
...
SAVE OUTFILE='REUWS2-update/sample3938-normalized-residuals.sav'
  /COMPRESSED.

SAVE TRANSLATE /TYPE=ODBC
  /CONNECT='DSN=MS Access Database;DBQ='+
    'S:\local\home\matt\csci7000\Project\Dataset\REUWS2-update\sample3938-normalized-residuals.mdb;'+
    'DriverId=25;FIL=MS Access;MaxBufferSize=2048;PageTimeout=5;'
  /ENCRYPTED
  /MISSING=RECODE
  /SQL='CREATE TABLE spss_output (ServiceCity varchar (255), ServiceState varchar (2), '+
    'ServiceZip varchar (5), MeterMake varchar (255), MeterModel varchar (255), MeterSize varchar '+
    '(255), MeterLocation varchar (255), dateofaccountinitiation datetime , SampleReads double , '+
    ...
    'double , Scottsdale_attitude_B double , Scottsdale_attitude_C double , RandomSequence double '+
    ', LogAnnualKgal double , LogNonseasonalKgal double , LogSeasonalKgal double , LogAnnualMean '+
    'double , LogAnnualStDev double , LogNonseasonalMean double , LogNonseasonalStDev double , '+
    'LogSeasonalMean double , LogSeasonalStDev double , NormalizedAnnual double , '+
    'NormalizedNonseasonal double , NormalizedSeasonal double , NormalizedAnnualPredictedByFamily '+
    'double , NormalizedAnnualResidualByFamily double , NormalizedNonseasonalPredictedByFamily '+
    'double , NormalizedNonseasonalResidualByFamily double , NormalizedSeasonalPredictedByFamily '+
    'double , NormalizedSeasonalResidualByFamily double , SurveyID double  NOT NULL, PRIMARY KEY '+
    '(SurveyID) )'
  /REPLACE
  /TABLE='SPSS_TEMP'
  /KEEP=ServiceCity, ServiceState, ServiceZip, MeterMake, MeterModel, MeterSize, MeterLocation, 
    ...
    Scottsdale_attitude_A, Scottsdale_attitude_B, Scottsdale_attitude_C, RandomSequence, LogAnnualKgal, 
    LogNonseasonalKgal, LogSeasonalKgal, LogAnnualMean, LogAnnualStDev, LogNonseasonalMean, 
    LogNonseasonalStDev, LogSeasonalMean, LogSeasonalStDev, NormalizedAnnual, NormalizedNonseasonal, 
    NormalizedSeasonal, NormalizedAnnualPredictedByFamily, NormalizedAnnualResidualByFamily, 
    NormalizedNonseasonalPredictedByFamily, NormalizedNonseasonalResidualByFamily, 
    NormalizedSeasonalPredictedByFamily, NormalizedSeasonalResidualByFamily, SurveyID
  /SQL='INSERT INTO spss_output (ServiceCity, ServiceState, ServiceZip, MeterMake, MeterModel, '+
    ...
    'Scottsdale_attitude_B, Scottsdale_attitude_C, RandomSequence, LogAnnualKgal, '+
    'LogNonseasonalKgal, LogSeasonalKgal, LogAnnualMean, LogAnnualStDev, LogNonseasonalMean, '+
    'LogNonseasonalStDev, LogSeasonalMean, LogSeasonalStDev, NormalizedAnnual, '+
    ...
    'NormalizedSeasonalResidualByFamily, SurveyID) SELECT ServiceCity, ServiceState, ServiceZip, '+
    'MeterMake, MeterModel, MeterSize, MeterLocation, dateofaccountinitiation, SampleReads, '+
    'SampleBegins, SampleEnds, AnnualKgal, SeasonalKgal, NonseasonalKgal, PctSeasonal, '+
    'Log_AnnualKgal_Bin, wave, `language`, q8c, q8d, q15a, q15h, q20f, q21a, q31e, q33l, '+
    ...
    'NormalizedAnnualResidualByFamily, NormalizedNonseasonalPredictedByFamily, '+
    'NormalizedNonseasonalResidualByFamily, NormalizedSeasonalPredictedByFamily, '+
    'NormalizedSeasonalResidualByFamily, SurveyID FROM SPSS_TEMP'
