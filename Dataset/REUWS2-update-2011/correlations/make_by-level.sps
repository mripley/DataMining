...
OMS
  ...
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='S:\local\home\matt\Data_Mining_project\Dataset\REUWS2-update\correlations\by-level.sav'.
...
CORRELATIONS
  /VARIABLES=AnnualKgal capita PctSeasonal PremiseYear SeasonalKgal 
    ...
    survey_years_in_home SurveyID RandomSequence
  /PRINT=TWOTAIL NOSIG
...
*.
CORRELATIONS
  /VARIABLES=Clayton_attitude_A Clayton_attitude_B Clayton_attitude_C Clayton_attitude_D 
